...
def draw_menu():
  global rgb_list
  pygame.draw.rect(screen, (0, 127, 127), [0, 0, WIDTH, 100])
  pygame.draw.line(screen, (255, 0, 0), (0, 70), (WIDTH,100), 3)
  ...
  red = pygame.draw.rect(screen, (255, 255, 0), [WIDTH -255, 10, 50,50])
